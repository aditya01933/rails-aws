...
class Ec2InstancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ec2_instance" do
    assert_difference("Ec2Instance.count") do
      post ec2_instances_url, params: { ec2_instance: { instance_id: @ec2_instance.instance_id } }
    end
  ...
  test "should update ec2_instance" do
    patch ec2_instance_url(@ec2_instance), params: { ec2_instance: { instance_id: @ec2_instance.instance_id } }
